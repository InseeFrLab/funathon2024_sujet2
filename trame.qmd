...
Le projet comporte de nombreux fichiers 
...
- En `R`, utiliser `renv` qui se charge de reconstruire un environnement cohérent avec celui qui a été défini par ***
- En `Python`, utiliser les environnements virtuels. Le plus simple est de lister
les dépendances
`requirements.txt` pour
