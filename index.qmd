...
Dans cette partie, vous allez exploiter les données pour produire trois outputs qui seront ensuite intégrées dans l'application web:
...
## Output 1: Le trafic par aéroport
...
## Output 2: Tableau HTML pour afficher des données
