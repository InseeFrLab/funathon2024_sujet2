...
```{.r include="R/figures.R" end-line="18"}
```
</details>
...
```{.r include="intermediates/exo4c.R"}
```
</details>
...
de `pax_apt_all` égales à `selected_date`. Utiliser celui-ci en faisant
...
```{.r include="R/figures.R" start-line="20"}
```
</details>
...
```{.r include="intermediates/exo5.R" start-line="20"}
```
</details>
