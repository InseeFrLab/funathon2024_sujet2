...
7. Faire tourner l'application avec la commande suivante dans un terminal:
    ...
    Et `VSCode` devrait vous proposer d'ouvrir cette fenêtre, cliquez dessus vous redirigera vers l'application. 

::: {.callout-note}
Si vous voulez retrouver le lien persistant de l'application, retourner sur la page _"Mes services"_ du [SSPCloud](https://datalab.sspcloud.fr/my-services) et cliquer sur le lien du port personnalisé
...
8. Stopper votre application avec <kbd>CTRL</kbd>+<kbd>C</kbd>. Ajouter le code suivant à votre application:
