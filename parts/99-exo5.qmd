...
de `pax_apt_all` égales à un certain mois et année (vous pouvez vous inspirer d'un filtre fait précédemment). Utiliser celui-ci en faisant
...
2. A partir de l'[exemple de démarrage de `leaflet`](https://rstudio.github.io/leaflet/articles/markers.html) {{< fa brands r-project >}} ou de l'[exemple canonique `folium`](https://python-visualization.github.io/folium/latest/getting_started.html#Adding-markers) ({{< fa brands python >}}),
...
4. Reproduire une carte similaire à celle présentée plus bas:
