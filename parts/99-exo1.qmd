...
4. Dans ce nouveau dossier, créez un script nommé `create_data_list.R` ({{< fa brands r-project >}}) ou `create_data_list.py` ({{< fa brands python >}}) et reportez-y la fonction que vous avez créée.
