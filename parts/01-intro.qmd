...
Une démonstration de cette application est disponible à l'adresse <https://rplane-dashboard.kub.sspcloud.fr/> ({{< fa brands r-project >}}) ou <https://pylot-dashboard.kub.sspcloud.fr/> ({{< fa brands python >}}). Ce tutoriel est également l'occasion d'apprendre quelques bonnes pratiques pour les projets {{< fa brands r-project >}} et {{< fa brands python >}}.
...
ces deux langages est assez minime.  
...
car elle permet de __réfléchir à l'objectif de l'application et à son public cible__.
