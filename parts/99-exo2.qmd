...
```{.python include="correction/src/import_data.py" start-line=10 end-line=49}
```
...
```{.r include="correction/R/import_data.R" start-line=22 end-line=36}
```
...
```{.python include="correction/src/import_data.py" start-line=51 end-line=68}
```
...
```{.r include="correction/R/import_data.R" start-line=38 end-line=53}
```
...
```{.python include="correction/src/import_data.py" start-line=71 end-line=89}
```
...
```{.r include="correction/R/import_data.R" start-line=56 end-line=72}
```
...
```{.python include="correction/src/import_data.py" start-line=92 end-line=111}
```
