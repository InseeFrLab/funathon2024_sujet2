...
* Dans le dossier `R/` ou `src/`, créez un script nommé `clean_dataframe.R` ({{< fa brands r-project >}}) ou `clean_dataframe.py` ({{< fa brands python >}}) et reportez-y la fonction que vous avez créée.
